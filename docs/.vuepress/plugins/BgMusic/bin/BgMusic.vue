          ...
          <div class="reco-bgm-cover" @click="changeBgmInfo(false)"
            ...
            <div v-show="isMini" class="mini-operation">
              <i v-show="this.curPlayStatus === 'playing' && isMini" @click.stop="pauseBgm"
                class="reco-bgm reco-bgm-pause"></i>
              <i v-show="this.curPlayStatus === 'paused' && isMini" @click.stop="playBgm"
                class="reco-bgm reco-bgm-play"></i>
            </div>
            <!-- 错误信息显示 -->
            ...
            <div v-show="!isMini" class="reco-bgm-info">
              ...
              <div class="reco-bgm-operation">
                ...
                <i v-show="curPlayStatus === 'paused'" ref="play" @click="playBgm"
                  class="reco-bgm reco-bgm-play play"></i>
        ...
        if (this.autoplay) {
          ...
          if (playPromise !== undefined) {
            playPromise.then(res => {
              console.log('%c 欢迎来到兜里有糖的博客 ',
                'background:#35495e ; padding: 1px; border-radius: 3px 0 0 3px;  color: #fff');

              console.log('%c 主页 %c http://www.sugarys.top/ ',
                'background:#35495e ; padding: 1px; border-radius: 3px 0 0 3px;  color: #fff',
                'background:#41b883 ; padding: 1px; border-radius: 0 3px 3px 0;  color: #fff');

              console.log('%c 微信 %c 17691389971 ',
                'background:#35495e ; padding: 1px; border-radius: 3px 0 0 3px;  color: #fff',
                'background:#41b883 ; padding: 1px; border-radius: 0 3px 3px 0;  color: #fff');
